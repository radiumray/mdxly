...
Blockly.Blocks.Microduino_KEYDigitalVal = {
  init: function() {
     var CHECK = [[Blockly.MDKeyReleased, 'KEY_RELEASED'],
                    [Blockly.MDKeyPressed, 'KEY_PRESSED'],
                    [Blockly.MDKeyPressing, 'KEY_PRESSING'],
                    [Blockly.MDKeyRelssing, 'KEY_RELEASING']];  
...
Blockly.Blocks.Microduino_KEYAnalogVal = {
  init: function() {
     var CHECK = [[Blockly.MDKeyReleased, 'KEY_RELEASED'],
                    [Blockly.MDKeyPressed, 'KEY_PRESSED'],
                    [Blockly.MDKeyPressing, 'KEY_PRESSING'],
