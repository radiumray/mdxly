...
Blockly.Arduino.ws2812Begin = function() {
  ...
  Blockly.Arduino.definitions_['define_ColorLED'] = '#include <Microduino_ColorLED.h>';
  Blockly.Arduino.definitions_['var_ColorLED'] = 'ColorLED strip = ColorLED('+LEDNumber+', '+LEDPin+');';
